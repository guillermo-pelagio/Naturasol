    ...
    public class SGCController : Controller
    {
        ...
        public ActionResult especificaciones()
        {
            if (((Session["usuarioId"]) != null))
            {
                ...
                string[] filePaths = Directory.GetFiles(Server.MapPath("~/Especificaciones/"));
                ...
                foreach (string filePath in filePaths)
                {
                    ...
                    files.Add(new Archivo { FileName = Path.GetFileName(filePath) });
                }
